...
Aim for a five-minute conversation and let the participant choose the pace. The ten-minute global limit is the maximum safety boundary, not a required duration. Invite the player to name one clue before a decision, then read the consequence and the short takeaway.
